...
const MobileMenu = () => {
    ...
    return (
        <div className="lg:hidden block z-40  absolute transform translate-y-14 bottom-0 w-full">
 <motion.div  className="bg-white grid  px-4 py-4 border-t border-t-yellow-400 grid-cols-4 ">
